        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 xl:gap-40">
            ...
            <div className="relative lg:pr-12">
              ...
              >
                <div className="flex items-center">
                  <DiUbuntu className="w-16 h-16 text-purple-500 mr-3" />
                  <h3 className="text-2xl font-bold text-slate-100">De Windows a Ubuntu</h3>
                </div>
                <div className="space-y-4">
                  ...
                  <p className="text-slate-300 leading-relaxed">
                    Motivado por la mentalidad exploratoria que ChatGPT despertó en mí, decidí migrar a Linux. Ubuntu me dio el control sobre mi sistema que Windows no podía ofrecer.
                  </p>
                  <div className="bg-green-900/50 rounded-lg p-4 border-l-4 border-green-500">
                    <div className="flex items-center text-slate-400">
                      ...
                      <span>La Decisión del Cambio</span>
                    </div>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="relative lg:pl-12">
              ...
              >
                <div className="flex items-center">
                  <svg className="w-16 h-16 text-green-400 mr-3" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M20 18c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2H0v2h24v-2h-4zM4 6h16v10H4V6z"/>
                  </svg>
                  <h3 className="text-2xl font-bold text-slate-100">Flujo de Trabajo Transformado</h3>
                </div>
                <div className="space-y-4">
                <div className="flex items-center text-slate-300">
                    <Calendar className="w-5 h-5 mr-2 text-green-400" />
                  ...
                  <p className="text-slate-300 leading-relaxed">
                    La terminal se volvió mi herramienta principal para instalar software, librerías y utilidades. Los escritorios virtuales de Ubuntu me ayudaron a organizar mi espacio de trabajo de forma mucho más eficiente.
                  </p>
                  <div className="bg-green-900/50 rounded-lg p-4 border-l-4 border-green-500">
                    <div className="flex items-center text-slate-400">
                      <svg className="w-5 h-5 mr-2 text-green-400" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <span>Impacto en mi Productividad</span>
                    </div>
                  </div>
                </div>
              </motion.div>
