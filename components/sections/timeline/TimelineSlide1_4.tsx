...
import { Calendar, Bot, Smartphone } from "lucide-react";
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 xl:gap-40">
            ...
            <div className="relative lg:pr-12">
              ...
              >
                <div className="flex items-center">
                  <Bot className="w-16 h-16 text-purple-500 mr-3" />
                  <h3 className="text-2xl font-bold text-slate-100">De ChatGPT a Claude</h3>
                </div>
                <div className="space-y-4">
                  ...
                  <p className="text-slate-300 leading-relaxed">
                    Buscando mejores explicaciones y código más preciso, descubrí Claude. Su capacidad para explicar conceptos complejos de forma clara y generar código superior marcó un antes y después en mi aprendizaje.
                  </p>
                  <div className="bg-green-900/50 rounded-lg p-4 border-l-4 border-green-500">
                    <div className="flex items-center text-slate-400">
                      ...
                      <span>El Cambio de Herramienta</span>
                    </div>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="relative lg:pl-12">
              ...
              >
                <div className="flex items-center">
                  <Smartphone className="w-16 h-16 text-green-400 mr-3" />
                  <h3 className="text-2xl font-bold text-slate-100">ADB: La Solución Encontrada</h3>
                </div>
                <div className="space-y-4">
                <div className="flex items-center text-slate-300">
                    <Calendar className="w-5 h-5 mr-2 text-green-400" />
                  ...
                  <p className="text-slate-300 leading-relaxed">
                    Gracias a Claude descubrí ADB (Android Debug Bridge), permitiéndome probar mi web app en mi teléfono a través de conexión USB. Una solución efectiva que me permitio desarrollar de manera responsive.
                  </p>
                  <div className="bg-green-900/50 rounded-lg p-4 border-l-4 border-green-500">
                    <div className="flex items-center text-slate-400">
                      <svg className="w-5 h-5 mr-2 text-green-400" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <span>Innovación por Necesidad</span>
                    </div>
                  </div>
                </div>
              </motion.div>
